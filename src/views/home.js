  ...
  return (
    <div className="home-container">
      <Helmet>
        ...
        <meta property="og:title" content="campusTrader" />
      </Helmet>
      <header data-thq="thq-navbar" className="home-navbar-interactive">
        <div data-thq="thq-navbar-nav" className="home-desktop-menu">
          <nav className="home-links">
            <Link to="/my-listings" className="home-navlink">
              My Listings
            </Link>
          </nav>
        </div>
        <div data-thq="thq-burger-menu" className="home-menu"></div>
        ...
        <Link to="/my-offers" className="home-navlink2">
          My Offers
        </Link>
        <Link to="/login" className="home-login1 button">
          Login
        </Link>
        <Link to="/faq" className="home-navlink3">
          FAQs
        </Link>
        <Link to="/mission" className="home-navlink4">
          <span>Mission</span>
          <br></br>
        </Link>
      ...
      <div className="home-container1">
        ...
        />
        <span className="home-text07">OR</span>
        <select className="home-select">
          <option value="null" selected>
            Select a Category
          </option>
          <option value="Option 2">Electronics</option>
          <option value="Option 3">Art Supplies</option>
          <option value="Option 4">Music</option>
          <option value="Option 5">Literature</option>
          <option value="Option 6">Workout Equipment</option>
        </select>
        <Link to="/listings" className="home-navlink5 button">
